...
<?php
	...
	if( isset($_POST['submit_data']) ) {
		...
		$ins_sql = "INSERT INTO dailyentry (store_num, employee_name, date, tred, tred_num, promo, cash, refunds, refunds_num) VALUES ('$store_num', '$employee_name', '$date', '$tred', '$tred_num', '$promo', '$cash', '$refunds', '$refunds_num')";
	...
	if ( isset($_POST['edit_data']) ) {
		...
		$edit_sql = "UPDATE dailyentry SET store_num = '$edit_store_num', employee_name = '$edit_employee_name', date = '$edit_date', tred = '$edit_tred', tred_num = '$edit_tred_num', promo = '$edit_promo', cash = '$edit_cash', refunds = '$edit_refunds', refunds_num = '$edit_refunds_num', flagged = '$edit_flagged', comments = '$edit_comments' WHERE id = '$edit_id' ";
