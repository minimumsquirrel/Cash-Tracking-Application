 	 		...
 	 		<form method="post">
				...
				echo "
					<tr>
						...
						<td>$rows2[flagged]</td>
						<td>$rows2[comments]</td>
						<td><a href='records.php?edit_id=$rows2[id]' class='btn btn-flag'>Flag</a></td>
						<td><a href='records.php?edit_id=$rows2[id]' class='btn btn-submit'>Edit</a></td>
