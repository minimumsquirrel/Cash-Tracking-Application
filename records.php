...
//Access Log Recording
	...
	if ($_POST['submit_data']) {
		...
		$ins_sql = "INSERT INTO access_logs (ip, username, page, selected_store, query, edit, organization, edited) VALUES ('$entered_ip', '$username_data', 'Records.php', '$stored_num', '$query', '$edit', '$user_organization', '$edited')";
