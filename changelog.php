...
<div class="container">
  ...
  <form method="post">
    ...
    <div class="form-group col-md-12">
      <textarea name="edit_changelog" rows="24" class="form-control" placeholder="Changelog" disabled required><?php echo $changelog; ?></textarea>
    </div>
  </form>
</div>
...
$entered_ip = mysqli_real_escape_string($conn, strip_tags($_SERVER["REMOTE_ADDR"]));
  ...
  $ins_sql = "INSERT INTO access_logs (ip, username, page, selected_store, organization) VALUES ('$entered_ip', '$username_data', 'Changelog.php', '$default_store', '$user_organization')";
