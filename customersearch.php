			...
			<form class="col-md-12" method="post">
		 	...
		 	<?php } 
				...
				$total_query = "WHERE store_num = '$store_num'";
	 			$sql = "SELECT * FROM customer_recovery $total_query and flag_reviewed = 'Y' and NOT flag_sent = 'Y' AND NOT flag_sent = 'N' ORDER BY date DESC LIMIT 0, 150";
				$run = mysqli_query($conn, $sql);
				...
				echo "
					<tr>
						...
						<td><a href='customersend.php?edit_id=$rows[id]' class='btn btn-submit'>Review</a></td>
