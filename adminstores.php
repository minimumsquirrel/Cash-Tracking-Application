...
//Access Log Recording
	...
	if ($_POST['submit']) {
		...
		$ins_sql = "INSERT INTO access_logs (ip, username, page, selected_store, query, edit, organization, edited, submitted) VALUES ('$entered_ip', '$username_data', 'AdminStores.php', '$store_num', '$query', '$edit', '$user_organization', '$edited', '$submitted')";
