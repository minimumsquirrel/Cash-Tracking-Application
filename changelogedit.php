...
if ($_POST['edit_data']) {
  ...
  $ins_sql = "INSERT INTO access_logs (ip, username, page, edit, organization, edited) VALUES ('$entered_ip', '$username_data', 'ChangelogEdit.php', '$edit', '$user_organization', '$edited')";
