...
//Access Log Recording
	...
	$edit = mysqli_real_escape_string($conn, strip_tags($edit_sql2));
		...
		$ins_sql = "INSERT INTO access_logs (ip, username, page, selected_store, query, edit, organization) VALUES ('$entered_ip', '$username_data', 'PhonebookEntry.php', '$stored_num', '$query', '$edit', '$user_organization')";
