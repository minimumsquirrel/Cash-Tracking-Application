...
?>
 ...
 <html lang="en">
  <head>
	...
	self.location='customerreview.php?store_num=' + val ;
	}
			...
			<div class="container">
				<div class="col-md-12">
					<h3>
						...
						<small class="text-muted">Store Manager Review</small>
					</h3>
					<hr>
				</div>
							...
							<hr>
								<div class="form-row">
									<div class="form-group col-md-6">
											...
											<select class="form-control" name="edit_flag_reviewed" required>
			...
			<form class="col-md-12" method="post">
		 	...
		 	<?php } 
				...
				$total_query = "WHERE store_num = '$store_num'";
	 			$sql = "SELECT * FROM customer_recovery $total_query and flag_reviewed = '' ORDER BY date DESC LIMIT 0, 150";
				$run = mysqli_query($conn, $sql);
				...
				echo "
					<tr>
						...
						<td><a href='customerreview.php?edit_id=$rows[id]' class='btn btn-submit'>Review</a></td>
						<td><a href='customerreview.php?del_id=$rows[id]' class='btn btn-secondary'>Delete</a></td>
					</tr>
				";
...
<?php
	...
	if( isset($_GET['del_id']) ) {
		...
		if(mysqli_query($conn, $del_sql)) { ?>
			<script>window.location = "customerreview.php";</script>
	<?php }	
